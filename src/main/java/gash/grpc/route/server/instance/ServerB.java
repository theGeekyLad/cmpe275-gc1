...
public class ServerB extends RouteServerImpl {

    public static void main(String[] args) throws Exception {
        RouteServerImpl.main(new String[]{"/home/thegeekylad/Classes/cmpe-275/lab-2/grpc-playground/grpc-playground/src/main/resources/conf/serverB.conf"});
    }
